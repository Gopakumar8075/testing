...
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    const ConnectWallet = () => {
      ...
      const { connectWithProvider } = (0,
      _useConnect__WEBPACK_IMPORTED_MODULE_5__ /* ["default"] */.Z)();
      const { 0: desktop, 1: setDesktop } = (0,
      react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
        ...
        react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment,
        {
          children: [
            ...
            react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)('button', {
              className:
                'text-white flex 2xs:text-[14px] lg:text-[18px] font-ralewayregular',
            ...
            /*#__PURE__*/ (0,
            react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
              _modal_popup_modal_popup__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z,
              {
                show: show,
                ...
                children: [
                  desktop
                    ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(
                        _nft_button_nft_button__WEBPACK_IMPORTED_MODULE_3__ /* ["default"] */.Z,
                        {
                          bgcolor: 'grey',
                          text: 'METAMASK',
                          onclick: () => {
                            connectWithProvider(
                              (0,
                              _testconnect_wallet_providers__WEBPACK_IMPORTED_MODULE_4__ /* .getMetaMaskProvider */.Q6)()
                            );
                          },
                        }
                      )
                  ...
                  /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(
                    _nft_button_nft_button__WEBPACK_IMPORTED_MODULE_3__ /* ["default"] */.Z,
                    {
                      ...
                      onclick: () => {
                        connectWithProvider(
                          (0,
                          _testconnect_wallet_providers__WEBPACK_IMPORTED_MODULE_4__ /* .getCoinbaseWalletProvider */.Bh)()
                        );
                      },
                    }
                  ),
                  /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(
                    _nft_button_nft_button__WEBPACK_IMPORTED_MODULE_3__ /* ["default"] */.Z,
                    {
                      ...
                      onclick: () => {
                        connectWithProvider(
                          (0,
                          _testconnect_wallet_providers__WEBPACK_IMPORTED_MODULE_4__ /* .getWalletConnectProvider */.Lu)()
                        );
                      },
                    }
                  ),
  ...
  /***/ 23942: /***/ (
    ...
    var cjs = __webpack_require__(63984); // CONCATENATED MODULE: ./src/components/connect-wallet/providers.js
    ...
    var login = __webpack_require__(39756); // CONCATENATED MODULE: ./src/components/connect-wallet/useConnect.js
...
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  /***/ 57113: /***/ (
    ...
    /* harmony import */ var _coinbase_wallet_sdk__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(45811);
    /* harmony import */ var _walletconnect_web3_provider__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(63984);
    ...
    const getCoinbaseWalletProvider = () => {
      const coinbaseWallet =
        new _coinbase_wallet_sdk__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.ZP(
          {
            appName: APP_NAME,
            appLogoUrl: APP_LOGO_URL,
            darkMode: false,
  ...
  /***/ 39756: /***/ (
    ...
    /* harmony import */ var _auth_auth__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(71667);
    /* harmony import */ var web3__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(3283);
    /* harmony import */ var web3__WEBPACK_IMPORTED_MODULE_1___default =
      /*#__PURE__*/ __webpack_require__.n(web3__WEBPACK_IMPORTED_MODULE_1__);
...
function NftFooter() {
                ...
                children: [
                  /*#__PURE__*/ jsx_runtime.jsx('div', {
                    children: /*#__PURE__*/ jsx_runtime.jsx('input', {
                      className:
                        'w-80 2xs:w-64 h-10 rounded-lg bg-black text-[#D4D4D4] border-[#D4D4D4] border-[1px] pl-2',
    ...
    var nft_button_module_default =
      /*#__PURE__*/ __webpack_require__.n(nft_button_module); // CONCATENATED MODULE: ./src/components/nft-nav-button/nft-nav-button.jsx
    const NftNavbutton = ({ value, url }) => {
      ...
      return /*#__PURE__*/ jsx_runtime.jsx(jsx_runtime.Fragment, {
        children: /*#__PURE__*/ jsx_runtime.jsx('button', {
          ...
          className:
            (router.route === url
              ? nft_button_module_default().buttonUnderLine
    ...
    var basic_layout_module_default =
      /*#__PURE__*/ __webpack_require__.n(basic_layout_module); // CONCATENATED MODULE: ./src/components/basic-layout/routes.js
    const routingData = [
      {
        route: '/',
        value: 'Home',
...
const getAccountChainChange = (provider, setConnect, setWalletAdd, setChainId)=>{
    ...
    var image_default = /*#__PURE__*/ __webpack_require__.n(next_image); // CONCATENATED MODULE: ./src/components/basic-layout/basic-layout.jsx
    const BasicLayout = ({ children }) => {
      const router = (0, next_router.useRouter)();
      const { 0: currentRoute, 1: setCurrentRoute } = (0, react.useState)(
        router.route
      ); //route state initializing
      const { 0: showMobileHamburger, 1: setShowMobileHamburger } = (0,
                  ...
                  children: /*#__PURE__*/ jsx_runtime.jsx(link_default(), {
                    ...
                    children: /*#__PURE__*/ (0, jsx_runtime.jsxs)('span', {
                      ...
                      children: [
                        /*#__PURE__*/ jsx_runtime.jsx('span', {
                          className:
                            '2xs:text-[20px] sm:text-[24px] font-extrabold text-white font-ethnocentric',
                          children: 'OWN',
                        }),
                        /*#__PURE__*/ jsx_runtime.jsx('span', {
                          className:
                            '2xs:text-[20px] sm:text-[24px] font-extrabold font-ethnocentric text-headerorange',
                          children: 'NFT',
                        }),
                      ],
                    }),
              ...
              /*#__PURE__*/ jsx_runtime.jsx('div', {
                ...
                children: /*#__PURE__*/ (0, jsx_runtime.jsxs)('div', {
                  ...
                  children: [
                    ...
                    connect || walletAdd?.length > 0
                      ? /*#__PURE__*/ jsx_runtime.jsx(nft_nav_button, {
                          value: 'Profile',
                          url: '/profile',
                        })
                      : /*#__PURE__*/ jsx_runtime.jsx(
                          connet_wallet /* default */.Z,
                          {}
                        ),
                  ],
                }),
 ...
 */ function BasicLayoutWrapper(component) {
    ...
    /* harmony default export */ const basic_layout = BasicLayout; // CONCATENATED MODULE: ./src/utilitis/BasicLayoutWrapper.js
