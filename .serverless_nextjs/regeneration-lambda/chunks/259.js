...
var marketplaceapi = __webpack_require__(1589);
;// CONCATENATED MODULE: ./src/store/slices/marketplace.slice.js
 ...
 */ const marketPlaceSlice = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "marketPlace",
    initialState,
    reducers: {},
    extraReducers: {
        [marketplaceapi/* getMarketPlaceApiData.pending */.b.pending]: (state)=>{
            state.pending = true;
            state.error = false;
        },
        [marketplaceapi/* getMarketPlaceApiData.fulfilled */.b.fulfilled]: (state, action)=>{
            let payload = action.payload[0].results;
            let page = action.payload[1];
            state.pending = false;
            state.nftMarketPlacedata = page === 1 ? payload : [
                ...state.nftMarketPlacedata,
                ...payload
            ];
        },
        [marketplaceapi/* getMarketPlaceApiData.rejected */.b.rejected]: (state)=>{
            state.pending = false;
            state.error = true;
        }
    }
...
/* harmony default export */ const marketplace_slice = (marketPlaceSlice.reducer);

// EXTERNAL MODULE: ./node_modules/axios/index.js
var axios = __webpack_require__(9669);
var axios_default = /*#__PURE__*/__webpack_require__.n(axios);
;// CONCATENATED MODULE: ./src/store/services/singlenftapi.js


const getSinglenftApiData = (0,redux_toolkit_cjs_production_min.createAsyncThunk)("singlenft/getdata", async (id)=>{
 ...
 */ const singleNftSlice = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "singlenft",
...
/* harmony default export */ const singlenft_slice = (singleNftSlice.reducer);

;// CONCATENATED MODULE: ./src/store/slices/connectWallet.slice.js
...
/* harmony default export */ const connectWallet_slice = (walletSlice.reducer);
...
const getMarketPlaceApiData = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.createAsyncThunk)("marketplace/getdata", async ({ url  })=>{
    console.log(url, "reaapi");
    const newData = collectionId ? collectionId : "";
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(`${NEXT_PUBLIC_BASE_URL}api/v1/nft${url}`);
    return [
        response.data,
        page
    ];
